...
SRC_URI = " \
    git://github.com/tensorflow/tensorflow.git;protocol=https;branch=r2.3;name=tensorflow \
    git://github.com/ARM-software/armnn.git;protocol=https;branch=branches/armnn_21_02;name=armnn;subdir=${WORKDIR}/armnn;destsuffix=armnn \
"
